...
#define OPCODE_NOT    0x0
#define OPCODE_XOR    0x1
#define OPCODE_ADDI   0x2
#define OPCODE_ADD    0x3
#define OPCODE_SUB    0x4
#define OPCODE_SRA    0x5
#define OPCODE_SLL    0x6
#define OPCODE_LW     0x7
#define OPCODE_SW     0x8
#define OPCODE_J      0x9
#define OPCODE_JAL    0xA
#define OPCODE_JR     0xB
#define OPCODE_BNE    0xC
#define OPCODE_BLT    0xD
